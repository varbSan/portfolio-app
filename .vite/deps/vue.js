...
function recursiveGetSubtree(instance) {
...
function hydrateOnIdle(timeout = 1e4) {
  return (hydrate2) => {
...
function hydrateOnVisible(opts) {
  return (hydrate2, forEach) => {
...
function hydrateOnMediaQuery(query) {
  return (hydrate2) => {
    if (query) {
...
function hydrateOnInteraction(interactions = []) {
  return (hydrate2, forEach) => {
...
function assignSlots(slots, children, optimized) {
...
function initSlots(instance, children, optimized) {
...
function patchProp(el, key, prevValue, nextValue, namespace, parentComponent) {
...
function defineSSRCustomElement(options, extraOptions) {
