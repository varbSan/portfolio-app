  ...
  <div class="flex h-dvh flex-col">
    <main class="grid place-items-center">
      <div class="sticky top-0 z-20 flex w-full justify-center">
        <ToggleGroup v-model="locale" type="single" size="xs" class="absolute left-0 top-0 ml-4 mt-4 flex gap-1  text-xs text-white/50">
          <!-- <ToggleGroupItem value="de" aria-label="Toggle german translation">
            DE
          </ToggleGroupItem> -->
          <ToggleGroupItem value="en" aria-label="Toggle english translation" class="text-xs font-light">
            EN
          </ToggleGroupItem>
          <ToggleGroupItem value="fr" aria-label="Toggle french translation" class="text-xs font-light">
            FR
          </ToggleGroupItem>
        </ToggleGroup>
        <MlNavBar class="my-2" />
